...
class GateController:
    ...
    def __init__(self):
        ...
        # do the handling
        self._button = Button(9, "button1", buttonhandler=None)
        ...
        self._model.addTransition(2, [TIMEOUT], 0)
    ...
    def stateDo(self, state):
        ...
        if state == 0:
            ...
            if self._gate.vehiclePresent()==False:
    ...
    def stateEntered(self, state, event):
        ...
        if state == 0:
            ...
            self._gate.close()
            self._display.showText('Welcome to PICO')
            ...
            self._gate.open()
            self._buzzer.beep()
            self._display.showText('Gate open caution')
